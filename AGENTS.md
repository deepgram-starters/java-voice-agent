...
Java (Javalin) demo app for Deepgram Voice Agent.
...
```
feat(java-voice-agent): add diarization support
fix(java-voice-agent): resolve WebSocket close handling
refactor(java-voice-agent): simplify session endpoint
